...
m.add_argument(
    "--train_dataset",
    type=str,
    default="/home/hyohyeongjang/bigdata/ModelTrainer/llm-kr/data/oig-smallchip2-dedu-slice_reviewed_week1-7_instruction_valid.csv",
    help="train dataset",
)
m.add_argument(
    "--eval_dataset",
    type=str,
    default="/home/hyohyeongjang/bigdata/ModelTrainer/llm-kr/data/oig-smallchip2-dedu-slice_reviewed_week1-7_instruction_test.csv",
    help="eval dataset",
)
m.add_argument(
    "--output_dir",
    type=str,
    default="temp/outputs",
...
h.add_argument(
    "--warmup_ratio", type=float, default=0.0, help="warnup ratio of learning rate"
)
h.add_argument(
...
o.add_argument(
    "--logging_strategy", type=str, default="steps", choices=["no", "steps", "epoch"]
)
...
def set_logger(log_dir):
    ...
    filer = logging.FileHandler(
        filename=f"{log_dir}/train_log.log", mode="w", encoding="utf-8"
    )
...
def main(args):
    ...
    # Setting Logger
    print(args.model)
    print(args.output_dir, 2222222222222222222222222)
