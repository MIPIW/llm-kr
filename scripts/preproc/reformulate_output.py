...
# 커맨드 예시: python reformulate_output.py
...
if __name__ == "__main__":
    ...
    F_INPUT_PATH = "inference_sample_240731.csv"
    ...
    for i in tqdm(range(num_of_iteration)):
        ...
        with torch.no_grad():
            ...
            for idx, gen_text in enumerate(generated_texts):
                input_text = df["output"][idx] # 재구조화 전
                print( repr(input_text), repr(gen_text), sep="\t", file=f_o)
